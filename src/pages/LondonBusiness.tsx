...
const AIRLINES = [
  ...
  },
  {
    ...
    duration: "~15h total",
    terminal: "Terminal 4",
    lounge: "No1 Lounge, T4 (third-party)",
    price: "LKR 478,000",
    note: "Comfortable layover at Kuwait — short connection",
  },
  {
    ...
    price: "LKR 498,000",
    note: "Award-winning Batik Air Business Class cabin",
  },
  {
    name: "Qatar Airways",
    iata: "QR",
    ...
    price: "LKR 520,000",
    note: "World's best airline — Qsuite Business Class",
  },
  {
    name: "Emirates",
    iata: "EK",
    ...
    duration: "~13h total",
    terminal: "Terminal 3",
    lounge: "Emirates Lounge, T3 (24hr, spa & dining)",
    price: "LKR 545,000",
    note: "Fully flat bed, on-demand dining, champagne",
  },
  {
    name: "Cathay Pacific",
    iata: "CX",
    ...
    duration: "~17h total",
    terminal: "Terminal 3",
    lounge: "The Wing Business Lounge, HKG + CX Lounge T3",
    price: "LKR 575,000",
    note: "Business Class with noodle bar & cabana showers at HKG",
  },
];
    ...
    <div style={{ fontFamily: "'Inter', -apple-system, sans-serif", background: "#f5f5f3", minHeight: "100vh", color: "#1a1a1a" }}>
      ...
      <div style={{ background: "#f5f5f3" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "clamp(36px,5vw,56px) clamp(16px,4vw,48px)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 20 }}>
            {[
              { airline: "Emirates", terminal: "T3", name: "Emirates Lounge, T3", detail: "Open 24 hours. Champagne on arrival, à la carte fine dining, barber, spa treatments with complimentary 15-min neck massage, jacuzzi. Consistently rated the world's best airline lounge.", icon: "👑" },
              { airline: "Qatar Airways", terminal: "T4", name: "Al Mourjan Business Lounge, T4", detail: "World-class buffet, cocktail bar, private shower suites, premium spirits selection, live cooking stations. Winner of multiple World Travel Awards for best lounge.", icon: "🌟" },
              { airline: "Cathay Pacific", terminal: "T3", name: "Cathay Pacific Business Lounge, T3", detail: "Open kitchen concept. Signature noodle bar, premium barista coffee, extensive wine list. CX also offers The Wing & The Pier lounges during your HKG layover.", icon: "🍜" },
              { airline: "Malaysia Airlines", terminal: "T4", name: "Golden Lounge, T4", detail: "Malaysian and international cuisine, business facilities, comfortable rest zones, premium Petronas-branded experience. Also enjoy the Satellite Lounge at KLIA during layover.", icon: "🌴" },
              { airline: "Kuwait Airways", terminal: "T4", name: "No1 Lounge, T4", detail: "Third-party lounge with solid hot food buffet, bar, shower rooms and business facilities. Good value Business Class option for budget-conscious travellers.", icon: "✦" },
              { airline: "SriLankan Airlines", terminal: "T4", name: "Partner Lounge Access, T4", detail: "SriLankan Business Class passengers have access to a partner lounge at Terminal 4. Direct service means a quick ~10h 45m flight — no layover lounge needed.", icon: "🌿" },
            ].map(l => (
